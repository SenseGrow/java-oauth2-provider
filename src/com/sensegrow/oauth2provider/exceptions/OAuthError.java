package com.sensegrow.oauth2provider.exceptions;

/**
 * This abstract class represents an OAuth error information. Actually, each
 * error should be represented by creating this sub class.
 * 
 *
 */
...
public abstract class OAuthError extends Exception {
	 ...
	 * 
	 * @param code
	 *            The HTTP status code which should be returned to the client.
	 * @param description
	 *            The human-readable string which describes the detail
	...
	/**
	 * Initialize this instance. This constructor should be used to represent
	 * the error of when basically the request is invalid. That means the HTTP
	 * status code is initialized as 400.
	 * 
	 * @param description
	 *            The human-readable string which describes the detail
	 *            information regarding the error.
	...
	/**
	 * Retrieve the error description. The human-readable string which describes
	 * the detail information regarding the error. This string is returned as
	 * the error_description property value.
	 * 
	...
	/**
	 * Retrieve the error type. This sub class must implement this method. This
	 * result is returned as the error property value.
	 * 
	...
	/**
	 * This exception represents that the request is invalid. For instance, this
	 * error type is "invalid_request".
	 * 
	 *
	 */
	public static class InvalidRequest extends OAuthError {
		...
		/**
		 * Retrieve the error type string. This method returns the fixed string
		 * "invalid_request".
		 */
		@Override
	...
	/**
	 * This exception represents that the client is invalid. For instance, this
	 * error type is "invalid_client".
	 * 
	 *
	 */
	 ...
	 * request, or was issued to another client. For instance, this error type
	 * is "invalid_grant".
	 * 
	 *
	 */
	 ...
	 * exceeds the scope granted by the resource owner. For instance, this error
	 * type is "invalid_scope".
	 * 
	 *
	 */
	...
	/**
	 * This means that the access token passed to the API's endpoint has already
	 * been expired. For instance, this error type is "invalid_token".
	 * 
	 *
	 */
